                ...
                <div class="col-sm-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" class="form-horizontal" action="" name="portfolio_edit" id="portfolio_edit" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="<?php echo $portfolio[0]->id; ?>">
                                <div class="form-group">
                                    <label class="col-md-3 col-sm-4 control-label">Name:</label>
                                    <div class="col-sm-6">
                                        <input type="text" name="name" value="<?php echo $portfolio[0]->name; ?>" id="name" placeholder="Enter Name" class="form-control" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <img src="<?php echo base_url(); ?>uploads/images/portfolio/<?php echo $portfolio[0]->image; ?>" alt="<?php echo $portfolio[0]->image; ?>" width="200">
                                        <input type="file" name="image" id="image">
                                        <input type="hidden" value="<?php echo $portfolio[0]->image; ?>" name="old_image">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 col-sm-4 control-label">Content:</label>
                                    <div class="col-sm-8">
                                        <textarea name="content" id="content" placeholder="Enter content" class="form-control ckeditor"><?php echo $portfolio[0]->content; ?></textarea>
                                    </div>
                                </div>
