...
<div class="container-fluid">
    <div class="row">
      <div class="main">
        ...
        <?php } ?>
        <h1 class="page-header">Edit Career</h1>
        <div class="row">
          <div class="col-sm-12">
            <div class="panel panel-default">
              <div class="panel-heading">Edit Career</div>
              <div class="panel-body">
              <form role="form" class="form-horizontal" action="" name="admin_editcareer" id="admin_editcareer" method="post" enctype="multipart/form-data">
                  <input type="hidden" name="id" id="id" value=<?php echo $career->id; ?>>
                  
                  <div class="form-group">
                    <label class="col-md-3 col-sm-4 control-label">Title *:</label>
                    <div class="col-sm-6">
                        <input type="text" name="title" id="title" placeholder="Enter title" class="form-control" value="<?php echo $career->title; ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-md-3 col-sm-4 control-label">Content *:</label>
                    <div class="col-sm-6">
                      <textarea id="content" class="form-control ckeditor" rows="3" name="content"><?php echo $career->content; ?></textarea>
                    </div>
                  </div>
