                ...
                <div class="col-sm-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" class="form-horizontal" action="" name="admin_editimages" id="admin_editimages" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="id" id="id" value=<?php echo $images->id; ?>>
                                <input type="hidden" name="old_img" id="old_img" value=<?php echo $images->image; ?>>

                                <div class="form-group">
                                    <label class="col-md-3 col-sm-4 control-label">Name *:</label>
                                    <div class="col-sm-6">
                                        <input type="text" name="name" id="name" placeholder="Enter name" value="<?php echo $images->name; ?>" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 col-sm-4 control-label">Image *:</label>
                                    <div class="col-sm-6">
                                        <img src=<?php echo base_url() . 'uploads/images/images/' . $images->image; ?>  width="200"></img>
