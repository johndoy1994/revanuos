...
<div class="container-fluid">
    <div class="row">
        <div class="main">
            ...
            <h1 class="page-header">Create Career</h1>
            <div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">Create New Career</div>
                        <div class="panel-body">
                            <form role="form" class="form-horizontal" action="" name="admin_addcareer" id="admin_addcareer" method="post" enctype="multipart/form-data">
